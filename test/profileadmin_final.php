...
?>
  <nav>
        <div class="navbar">
          <ul>
            ...
            <li><a href="profileadmin_final.php">
  ...
  <div class="container">
    ...
    <h4 style="font-size: 30px; padding-right: 510px;">Roll no:</h4><c style="font-size=10px; padding-left:230px"><?php echo $row['roll_number'];?></c><br>
    <h4 style="font-size: 30px; padding-right: 510px;">Email id:</h4><c style="font-size=10px; padding-left:230px"><?php echo $row['email'];?></c><br>
